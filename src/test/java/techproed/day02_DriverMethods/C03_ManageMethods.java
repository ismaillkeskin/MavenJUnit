...
public class C03_ManageMethods {
    public static void main(String[] args) throws InterruptedException {
        ...
        webElementler'e browser maximize olmadığı için ulaşamayabiliriz. Dolayısıyla browser'ı açtıktan sonra
        maximize yaparsak driver bütün webElementleri görür ve rahatlıkla müdahale edebiliriz. Bu yüzden
