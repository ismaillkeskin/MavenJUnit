...
public class C01_ExplicitWait extends TestBase {
    ...
    public void test01() {
       ...
       //Hello World! Yazının sitede oldugunu test et
        ...
        //Locate'ini aldığım helloWorldText webelementini görünür olana kadar explicit wait ile bekleyeceğim
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
        wait.until(ExpectedConditions.visibilityOf(helloWorld));
        //visibilityOf() method'u ile görünür olana kadar bekler
